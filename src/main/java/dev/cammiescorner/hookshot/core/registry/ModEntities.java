...
public class ModEntities {
	...
	//-----Entities-----//
	public static final EntityType<HookshotEntity> HOOKSHOT_ENTITY = create("hookshot", FabricEntityTypeBuilder.<HookshotEntity>create(SpawnGroup.MISC, (type, world) -> new HookshotEntity(world)).dimensions(EntityDimensions.fixed(0.5f, 0.5f)).build());
